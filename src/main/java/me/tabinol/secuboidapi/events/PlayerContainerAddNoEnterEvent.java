...
public class PlayerContainerAddNoEnterEvent extends LandEvent {
    ...
    ApiPlayerContainer playerContainer;
     ...
     */
    public PlayerContainerAddNoEnterEvent(final ApiLand land, final ApiPlayerContainer playerContainer) {
     ...
     */
    public ApiPlayerContainer getPlayerContainer() {
