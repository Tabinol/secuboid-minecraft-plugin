...
public class PlayerLandChangeEvent extends LandEvent implements Cancellable {
     ...
     */
    public PlayerLandChangeEvent(final ApiDummyLand lastDummyLand, final ApiDummyLand dummyLand, final Player player,
            final Location fromLoc, final Location toLoc, final boolean isTp) {

        super(dummyLand);
        this.lastDummyLand = lastDummyLand;
        
        if(lastDummyLand instanceof ApiLand) {
            lastLand = (ApiLand) lastDummyLand;
        } else {
            lastLand = null;
        }
     ...
     */
    public ApiDummyLand getLastLandOrOutside() {
