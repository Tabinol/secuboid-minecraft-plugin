...
/**
 * The Interface ApiParameters. It is where you can register or get permissions
 * or flags.
 */
public interface ApiParameters {
     ...
     */
    public ApiPermissionType registerPermissionType(String permissionName, boolean defaultValue);
     ...
     */
    public ApiFlagType registerFlagType(String flagName, Object defaultValue);
     ...
     * @return the permission type
     */
    public ApiPermissionType getPermissionType(String permissionName);
     ...
     * @return the flag type
     */
    public ApiFlagType getFlagType(String flagName);
     ...
     * @return the permission type
     */
    public ApiPermissionType getSpecialPermission(SpecialPermPrefix prefix, Material mat);
}
